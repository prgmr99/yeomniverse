  ...
  const dirLabel =
    direction === 'bull'
      ...
      : direction === 'bear'
        ...
        : 'neutral';
  if (score >= 80)
    return `The market is in extreme one-way ${dirLabel} conditions — a rare, high-conviction trending environment. Multiple technical indicators are simultaneously aligned. While these conditions can produce exceptional returns for trend followers, they also carry elevated reversal risk.`;
  if (score >= 60)
    return `A strong ${dirLabel} one-way trend is active. Technical indicators are broadly aligned, confirming directional conviction. Trend-following strategies historically perform well in this zone.`;
  if (score >= 40)
    return `A moderate ${dirLabel} trend is underway. The market shows directional bias but with some conflicting signals. This is a confirmed trending environment, though not at peak conviction.`;
  if (score >= 20)
    return `A weak ${dirLabel} directional bias is present. The market is not clearly trending, and some indicators conflict. Caution is warranted for trend-following approaches.`;
...
export default async function BriefingDatePage({
  ...
  const fearGreedColor = fearGreed
    ? getFearGreedColor(fearGreed.score)
    : '#86868B';
  ...
  const articleSchema = {
    ...
    publisher: {
      ...
      logo: {
        '@type': 'ImageObject',
        url: `${DOMAIN}/images/favicon/icon-512.png`,
      },
    },
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Home', item: DOMAIN },
      {
        ...
        item: `${DOMAIN}/briefing`,
      },
      {
        '@type': 'ListItem',
        position: 3,
        name: `Briefing ${date}`,
        item: `${DOMAIN}/briefing/${date}`,
      },
    ],
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <p className="text-white/60 text-lg max-w-2xl">
            AI-curated analysis of top financial news with One-Way Market Index
        ...
        {(oneWay || fearGreed) && (
          <section className="mb-12">
            <h2 className="text-xl font-semibold mb-5 text-white/80">
              Market Pulse
            </h2>
                ...
                <div className="p-5 rounded-2xl bg-white/5 border border-white/10">
                  ...
                  <div className="flex items-end gap-3 mb-3">
                    ...
                    <span
                      ...
                      style={{
                        color: oneWayColor,
                        backgroundColor: `${oneWayColor}22`,
                      }}
                    >
                      {oneWay.label}
                    </span>
                  ...
                  <div className="flex items-end gap-3 mb-3">
                    ...
                    <span
                      ...
                      style={{
                        ...
                        backgroundColor: `${fearGreedColor}22`,
                      }}
                    >
                      {fearGreed.rating}
                    </span>
                  ...
                  <div className="relative h-2 rounded-full bg-white/10 overflow-hidden">
                    <div
                      ...
                      style={{
                        ...
                        backgroundColor: fearGreedColor,
                      }}
                    />
                  </div>
                </div>
        ...
        <section className="mb-12 p-6 rounded-2xl bg-white/5 border border-white/10">
          ...
          <p className="text-sm text-white/60 mb-4">
            The One-Way Market Index is a proprietary composite indicator
            measuring trend strength across 7 technical signals. Learn how it's
            calculated and what each score range means.
          </p>
          <Link
            href="/one-way-index"
        ...
        <p className="text-xs text-white/30 border-t border-white/10 pt-6">
          This briefing is generated by AI for informational purposes only. It
          does not constitute financial advice. Past market conditions do not
          predict future performance. Always conduct your own research before
