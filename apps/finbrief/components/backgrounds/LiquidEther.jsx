...
class MouseClass {
  ...
  init(container, disableInteraction = false) {
    this.container = container;
    ...
    // Only add event listeners if interaction is enabled
...
// ─────────────────────────────────────────────────────────────────────────────
// SHADER PASS CLASSES (require Common instance)
// ─────────────────────────────────────────────────────────────────────────────
...
class ExternalForce extends ShaderPass {
  ...
  init(simProps) {
    ...
    this.mouseMesh = new Mesh(mouseG, mouseM);
...
// ─────────────────────────────────────────────────────────────────────────────
// SIMULATION CLASS (requires Common and Mouse instances)
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// OUTPUT CLASS (requires Common, Mouse, paletteTex, bgVec4)
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// WEBGL MANAGER CLASS (requires isVisibleRef, rafRef as part of props)
// ─────────────────────────────────────────────────────────────────────────────
...
class WebGLManager {
  constructor(props, common, mouse, paletteTex, bgVec4) {
    ...
    this.paletteTex = paletteTex;
    this.bgVec4 = bgVec4;
    this.isVisibleRef = props.isVisibleRef;
    this.rafRef = props.rafRef;

    this.common.init(props.$wrapper);
    this.mouse.init(props.$wrapper, props.disableInteraction);
...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    // Create instances of module-level classes
